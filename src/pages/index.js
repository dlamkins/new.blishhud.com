...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Join our <a target="_blank" href="https://discord.gg/HzAV82d">Discord channel</a> (more than 6,200 users!), contribute to Blish HUD development, get help in developing your modules, and showcase your work to other Blish HUD users.
      </>
    ),
  },
];
        ...
        <div className="container">
          ...
          <div className={styles.buttons}>
            <Link
              ...
              to='https://github.com/blish-hud/Blish-HUD/releases/download/v1.0.0/Blish.HUD.1.0.0.zip'>
                Download Latest
            </Link>&nbsp;
            <Link
              className={clsx(
